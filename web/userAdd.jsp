...
<div class="main">
	...
	<form id="form1" name="form1" method="post" action="<%=request.getContextPath()%>/userAdd.action">
			...
			<table class="box">
			   <tbody><tr>
				 ...
				 <tr>
					...
					<td><input type="text" name="account" class="text" id="loginName" value=""> <font color="red">*</font><font color="red" id="loginName_span"></font></td>
				</tr>
				 <tr>
				 ...
				 <tr>
					...
					<td><input type="password" name="firmpassword" class="text" id="rpassword" value=""> <font color="red">*</font></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="date" class="text" id="birthDate" value=""> </td>
				</tr>
				<tr>
